...
Ray Tracer project for CS352. Currently has implemented Whitted illumination model, Phong shading, reflection/refraction, triangle mesh intersection, Phong interpolation and cube mapping. Also is multithreaded for efficiency's sake. In the future the multithreading should probably be improved, antialiasing and soft shadows should be added, and acceleration structures are needed.
